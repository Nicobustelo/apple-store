                            ...
                            <FormItem>
                                ...
                                <FormControl>
                                    <ImageUpload  
                                        ...
                                        disabled={loading}
                                        onChange={(url) => field.onChange((prevImages: { url: string }[]) => [...prevImages, { url: url }])}
                                        onRemove={(url) => field.onChange((prevImages: { url: string }[]) => prevImages.filter((current) => current.url !== url))}
                                    />
                                </FormControl>
                                <FormMessage />
                            </FormItem>
